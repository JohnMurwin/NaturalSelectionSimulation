...
namespace TWC.editor
{
	...
	public class TileWorldCreatorAssetEditor : Editor
	{
						...
						if (tileWorldCreatorAsset.mapBlueprintLayers[m].foldout)
						{
							...
							using (new GUILayout.HorizontalScope())
							{
								...
								using (new GUILayout.VerticalScope())
								{
									...
									{
										tileWorldCreatorAsset.mapBlueprintLayers[m].reorderableList = null;
									}
								}
							}
							EditorGUI.indentLevel --;
		...
		{
			//Debug.Log("CREATE REORDERABLE LIST " + tileWorldCreatorAsset.mapBlueprintLayers[_layerIndex].stack.Count);
			//var _layerIndex = m;
